...
func certificateProblem(host string) problem.Problem {
	return problem.New(problem.CategoryProductService, "iam.certificate_untrusted",
		fmt.Sprintf("the certificate ThunderID at %s presents is not trusted by this machine", host)).
