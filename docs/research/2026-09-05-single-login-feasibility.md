...
- **Asgardeo / WSO2 Account Platform:** Documents trusted token issuers, exchange grants and linked local accounts for RBAC. This supports exchange feasibility, not automatic access to every management API. [Official guide](https://wso2.com/account-platform/docs/guides/authentication/configure-token-exchange/).
